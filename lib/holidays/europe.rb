...
module Holidays
  ...
  module Europe # :nodoc:
    def self.defined_regions
      [:at, :ch_lu, :ch_ur, :ch_sz, :ch_ow, :ch_nw, :ch_gl, :ch_zg, :ch_fr, :ch_so, :ch_ai, :ch_sg, :ch_ag, :ch_ti, :ch_vs, :ch_ju, :de_bw, :de_by, :de_nw, :de_rp, :de_sl, :li, :ch_zh, :ch_be, :ch_bs, :ch_bl, :ch_sh, :ch_ar, :ch_gr, :ch_tg, :ch_vd, :ch_ge, :de, :ch_ne, :de_he, :de_st, :ch, :cz, :dk, :no, :de_sn, :de_bb, :de_mv, :de_th, :el, :es, :es_m, :es_cn, :es_cm, :es_pv, :es_ct, :es_na, :es_v, :es_vc, :es_mu, :es_lo, :es_ib, :es_ga, :es_an, :es_ce, :es_o, :es_ex, :es_ar, :es_cl, :fr, :gb, :ie, :je, :gb_jsy, :gg, :gb_gsy, :gb_eng, :gb_wls, :gb_eaw, :gb_nir, :gb_sct, :im, :gb_iom, :gb_con, :hu, :is, :it, :nl, :pl, :pt]
    end
